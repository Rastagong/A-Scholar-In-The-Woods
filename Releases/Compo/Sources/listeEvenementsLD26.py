...
class Scholar3(PNJ):
    ...
    def _gererEtape(self):
        ...
        if self._etapeTraitement == 2 and self._xTile == 9 and self._yTile == 7 and self._deplacementBoucle is False and self._etapeMarche == 1:
            self._lancerTrajet(["RGauche"], True)
            self._etapeTraitement += 1
        if self._etapeTraitement == 3 and self._boiteOutils.interrupteurs["MonstreApparition"].voir() is True:
            self._lancerTrajet(["RBas",1000,"RDroite",1000,"RHaut",1000,"RGauche",1000], False)
            self._etapeTraitement += 1
...
class Monstre(PNJ):
    ...
    def _gererEtape(self):
        ...
        if self._etapeTraitement == 2 and self._etapeMarche == 1:
            self._lancerTrajetEtoile(self._boiteOutils.cheminVersPosition, self._xTile, self._yTile, self._c, 7, 9, arretAvant=True)
